...
return (
    ...
    <div className="container pt-4">
        <div className="row">
            ...
            <p className="col-lg-12 col-lg-5">Here you can create your CV by answering question and getting it
                ready htmlFor download or applying to jobs through the platform.
            </p>
        </div>
    </div>
    {/* End big title */}
    ...
    <div className="row">
      ...
      <div className="col-md col-lg">
        <label htmlFor="lastName" className="mb-3 mt-3 mt-lg-0">
          Last Name
        </label>
        <input
          type="text"
    ...
    <div className="row mt-3">
      <div className="col-md col-lg me-3">
        <label htmlFor="profession" className="mb-3">
          Profession
        </label>
        <input
          type="text"
      ...
      <div className="col-md col-lg">
        <label htmlFor="country" className="mb-3 mt-3 mt-lg-0">
          Country
        </label>
        <input
          type="text"
    ...
    <div className="row mt-3">
      ...
      <div className="col-md col-lg-8">
        <label htmlFor="phone" className="mb-3 mt-3 mt-lg-0">
          Mobile Number
        </label>
        <br />
        <input
    ...
    <div className="row mt-3">
      <div className="col-6">
        <label htmlFor="personalPhoto" className="d-none d-lg-block">
          Personal Photo
        </label>
        <label htmlFor="personalPhoto" className="d-lg-none">
          Upload CV
        </label>
      </div>
    </div>
